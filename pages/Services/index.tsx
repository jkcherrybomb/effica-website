            ...
            <InnerWrapper>
                ...
                <Localized lang={'pl'}>
                    <p>
                        ...
                        także optymalizacji funkcjonalności SAP w zakresie
                        procesów przemysłowych i organizacji projektów dla
                        klientów (System projektowy SAP), Controllingu,
                        Gospodarki remontowej oraz Organizacja bezpiecznej pracy
                        (Work Clearance Management) systemu SAP S/4 Hana.
                        Zajmujemy sie też integracją SAP z serwisami webowymi w
                        technologiach SharePoint oraz DotNetNuke.
                    </p>
                    <p>
                        Regularnie współpracujemy i świadczymy podwykonawstwo
                        dla dużych przedsiębiorstw informatycznych. Nasi
                        konsultanci pracują przy projektach na terenie Polski i
                        Unii Europejskiej.
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            SAP Support - opieka nad działającymi systemami{' '}
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        Klientowi na uzyskanie wysokiego standardu usług na
                        bardzo korzystnym pułapie kosztów.
                    </p>
                    <p>Korzyści z nearshoringu dla klienta:</p>
                    <ul>
                        <li>
                            Skupienie się na głownym obszarze działalnosci.{' '}
                        </li>
                        ...
                        <li>
                            Zmniejszenie ilości własnych środków trwałych
                            Klienta
                        </li>
                        <li>
                            Łatwość analizy kosztów - jasne metody rozliczeń
                        </li>
                        <li>Możliwość dokładnego planowania kosztów</li>
                    </ul>
                    <b>Nearshoring w usługach:</b>
                    <p>
                        Outsourcing infrastruktury IT (systemów innych niż
                        mySAP)
                    </p>
                    <ul>
                        <li>
                    ...
                    <p>
                        Effica dostarcza usługi nearshoringu, zapewniając
                        Klientom profesjonalną obsługę. Dobre kompetencje
                        językowe naszych konsultantów pozwalają uniknąć
                        problemów komunikacyjnych. Biznesowa i regulacyjna
                        znajomość poszczególnych państw, a także znajomość
                        specyfiki poszczególnych branż działalności biznesowej
                        jest gwarancją, że Klient powierza swoje procesy
